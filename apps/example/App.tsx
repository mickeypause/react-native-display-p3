import { P3Module, P3View } from 'react-native-p3';
    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
          <Text style={[styles.screenTitle, styles.inkText]}>sRGB vs Display-P3</Text>
          ...
          <Group name="Color Blocks">
            ...
            <View style={styles.legendRow}>
              ...
              <Text style={[styles.legendText, styles.inkText]}>
          ...
          <Group name="Typography (H1/H2/Body)">
            <View style={styles.row}>
              ...
              <View style={styles.column}>
                <Text style={[styles.legendText, styles.inkText]}>Display-P3 (views only)</Text>
                <Text style={[styles.h1, styles.srgbText]}>Heading 1</Text>
                <Text style={[styles.h2, styles.srgbText]}>Heading 2</Text>
                <Text style={[styles.body, styles.srgbText]}>
                  Labels use sRGB; wide gamut is shown in P3View swatches above.
                </Text>
              </View>
            </View>
          </Group>
...
function Group(props: { name: string; children: React.ReactNode }) {
  return (
    <View style={styles.group}>
      <Text style={[styles.groupTitle, styles.inkText]}>{props.name}</Text>
      {props.children}
    </View>
  );
}
